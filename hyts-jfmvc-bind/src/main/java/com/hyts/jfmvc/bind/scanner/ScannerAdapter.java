...
public final class ScannerAdapter {
	 ...
	 * @param @param clazz
	 * @param @return    参数  
	 * @return List<Annotation>    返回类型  
	 * @throws  
	 */ 
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public Map<String,Annotation> scanField(Class clazz,Class annotation)
	{
	 ...
	 * @throws  
	 */ 
	public Map<String,Annotation> scanMethod(Class clazz,Class annotation)
	{
		Method [] methods = clazz.getDeclaredMethods();
		Map<String,Annotation> annotationMap = new HashMap<String,Annotation>();
		for(Method method:methods)
		{
			Annotation fieldAnnotation = method.getAnnotation(annotation);
