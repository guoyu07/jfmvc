...
public class TestBind extends TestCase{
	...
	protected void setUp() throws Exception {
		...
		domains.addBindSubject(TestService.class.getName(), TestServiceImpl.class.getName());
		injector = new DefaultClassInjector(domains);
		injector.knit();
	}

	public void testMethod()
	{
		injector.getInjector().getInstance(TestServiceController.class).test();
	}
}
